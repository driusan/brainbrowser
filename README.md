![LOGO](https://brainbrowser.cbrain.mcgill.ca/img/bb-logo-white-mini-cropped.png) [![Build Status](https://travis-ci.org/driusan/brainbrowser.svg?branch=master)](https://travis-ci.org/driusan/brainbrowser)
